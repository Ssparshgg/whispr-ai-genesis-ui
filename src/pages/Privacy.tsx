					...
					<div className="bg-card/50 backdrop-blur border border-border/20 rounded-xl p-8 space-y-6">
						...
						<section>
							...
							<p className="text-muted-foreground leading-relaxed">
								...
								provide our services and fulfill legal obligations. Generated
								voice files are stored temporarily for download and then
						...
						<section>
							...
							<p className="text-muted-foreground leading-relaxed">
								...
								analytics, and infrastructure. These providers are contractually
								bound to protect your data and use it only for the specified
								purposes.
							</p>
						</section>
						...
						<section>
							<h2 className="text-2xl font-bold mb-4 text-primary">
								7. AI Training and Content Usage
							</h2>
							<p className="text-muted-foreground leading-relaxed">
								We do not use your text inputs or generated voice content to
								train our AI models. Your content remains private and is used
								solely to provide the requested voice generation service.
							</p>
						</section>
						...
						<section>
							...
							<p className="text-muted-foreground leading-relaxed">
								...
								contact us at{" "}
								<a
									href="mailto:privacy@seducely.ai"
